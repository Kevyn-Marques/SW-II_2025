...
if ($busca !== '') {
    $paises = array_filter($paises, function ($pais) use ($busca) {
        return strpos(strtolower($pais['translations']['por']['common']), $busca) !== false;
    });
}
?>
  ...
  <div class="container">
    ...
    <?php else: ?>
      <?php foreach ($paises as $pais): ?>
        <div class="card">
          <h3><?php echo $pais['translations']['por']['common']; ?></h3>
          <img src="<?php echo $pais['flags']['svg']; ?>" alt="Bandeira de <?php echo $pais['translations']['por']['common']; ?>">
